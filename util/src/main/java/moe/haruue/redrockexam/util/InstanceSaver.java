...
public class InstanceSaver implements Serializable {
    ...
    /**
     * 在 {@link android.app.Application} 的子类里初始化，如果继承了 {@link moe.haruue.redrockexam.util.abstracts.HaruueApplication} 则无需再进行初始化
     */
    ...
    /**
     * 保存单例到 savedInstance ，请添加以下代码到 {@link android.app.Activity} 的子类中，如果继承 {@link moe.haruue.redrockexam.util.abstracts.HaruueActivity} 则无需再添加
     * {@code
     *      @Override
