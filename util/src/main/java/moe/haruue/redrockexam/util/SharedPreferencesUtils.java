...
public class SharedPreferencesUtils {
    ...
    /**
     * 获取本工具类对应的 {@link android.content.SharedPreferences.Editor}<br>
     *     直接操作 {@link android.content.SharedPreferences.Editor} 时请手动调用 {@link SharedPreferences.Editor#apply()}
     * @return 工具类对应的 {@link android.content.SharedPreferences.Editor}
     */
